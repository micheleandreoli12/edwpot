 ...
 */
@WebServlet("/ex/RegionsandCountriesPr")
public class RegionsandCountriesPr extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DaoCountryPrep dao = new DaoCountryPrep(ds);
...
//        }
        request.setAttribute("countries", dao.getCountries(s,Integer.parseInt(request.getParameter("fav"))));
